...
# ============================================================
# make_yolo_seg_region_density_from_source_v6_shrink_label.py
#
# 목적:
...
#   - 목적: v6의 class 안정성을 유지하면서 과대 mask를 줄이기 위해 label polygon만 shrink
#
# 입력:
#   src_dataset_root/
...
def main():
    ...
    print("noise and seg label:     image=noisy keep mask, label=full source ID")
